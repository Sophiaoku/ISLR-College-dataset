...
#so many ways to get the confusion matrix
...
#predictions to compare with decision tree

p <- predict(rf.model,test)
table(p,test$Private)


#model would perform better as a single tree (DS) vs a random forest.